...
class PlayFair:
    ...
    def getLocation(self,letter):
        ...
        return [row,col]
    #########################################################
    #encryption called function
    #Message is passed as an argument and message is encdoded
    #########################################################
    def encrypt(self,message):
        ...
        while n<=len(message)-1:
            ...
            r = message[n+1]
            #print("va", m,r)
            cipherText = cipherText + ''.join(self.getCodedDigraph([m,r]))
            n=n+2
            
        print(cipherText)
        return cipherText
    ######################################################################    
    #decryption called function
    #Ciphertext message is passed as an argument and ciphertext is decoded
    ######################################################################
    def decrypt(self,message):
        ...
        while n<=len(message)-1:
            m = message[n]
            r = message[n+1]
            plainText = plainText + ''.join(self.getCodedDigraph([m,r]))
            n=n+2
...
###########################################################################
    ...
    #print(myCipher.getCodedDigraph(['I','O']))
    decision = ""
    key = ""
    message = ""
    ...
    if decision == '1':
        ...
        message=input()
        cipher = myCipher.encrypt(message)
